...
| [Ticket 03](IT-Support-Troubleshooting-Lab/Ticket-03-Web-Service-Unavailable/Ticket-03-Web-Service-Unavailable) | Server remains reachable and DNS resolves correctly, but the company website is unavailable because the HTTP service is not running | Resolved |
